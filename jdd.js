...
var jdd = {
    ...
    compare: function () {
         ...
         */
        var leftValid = jdd.validateInput($('#json1').text(), jdd.LEFT);
        var rightValid = jdd.validateInput($('#json2').text(), jdd.RIGHT);
        ...
        var left = JSON.parse($('#json1').text());
        var right = JSON.parse($('#json2').text());
